...
<head>
    ...
    <link href="<? echo base_url() ?>assets/plugins/bootstrap/css/bootstrap.css" rel="stylesheet">
    <link href="<? echo base_url() ?>assets/plugins/node-waves/waves.css" rel="stylesheet" />
    <link href="<? echo base_url() ?>assets/plugins/animate-css/animate.css" rel="stylesheet" />
    <link href="<? echo base_url() ?>assets/css/style.css" rel="stylesheet">
    <link href="<? echo base_url() ?>assets/css/themes/all-themes.css" rel="stylesheet" />
</head>
...
<body class="theme-red">
    ...
    <script src="<? echo base_url() ?>assets/plugins/bootstrap/js/bootstrap.js"></script>
    <script src="<? echo base_url() ?>assets/plugins/bootstrap-select/js/bootstrap-select.js"></script>
    <script src="<? echo base_url() ?>assets/plugins/jquery-slimscroll/jquery.slimscroll.js"></script>
    ...
    <script src="<? echo base_url() ?>assets/js/pages/ui/modals.js"></script>
    <script src="<? echo base_url() ?>assets/js/demo.js"></script>
</body>
